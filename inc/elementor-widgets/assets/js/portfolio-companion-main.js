(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".portfolio-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".portfolio-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".portfolio-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.portfolio-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.portfolio-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.portfolio-subscribe-newsletter-area');
    if ($subscribe.length) {
