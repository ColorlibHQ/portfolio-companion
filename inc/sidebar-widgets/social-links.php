...
class Portfolio_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Portfolio ] Social Links', 'portfolio-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'portfolio-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'portfolio-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'portfolio-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'portfolio-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'portfolio-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'portfolio-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'portfolio-companion'); ?></label>
...
} // Class portfolio_social_links ends here


// Register and load the widget
function portfolio_social_links_widget_load() {
	register_widget( 'Portfolio_social_links' );
}
add_action( 'widgets_init', 'portfolio_social_links_widget_load' );